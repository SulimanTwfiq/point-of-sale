...
const DishCard = ({ item, onClick }) => {
  ...
  return (
    <div
      onClick={onClick}
      className="active:shadow-xl	 select-none  h-[250px] pt-[148px] relative px-3 py-6 text-sm text-center text-white cursor-pointer bg-secondary-1100 rounded-2xl "
    >
